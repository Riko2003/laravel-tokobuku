               ...
               <tbody>
                    @foreach($users as $user)
                         <tr>
                              ...
                              <td>
                                   @if($user->avatar)
                                       <img   src="{{asset('images/'.$user->avatar)}}"width="70px"/>
                                   @else
                                    N/A
                                   @endif
                              </td>
...
@endif
                              ...
                              <td>
                              <a   class="btn btn-info text-white btn-sm"  href="{{url('users/create')}}">Detail</a>
                              <a   class="btn btn-warning text-white btn-sm"  href="{{route('users.edit',[$user->id])}}">Edit</a>
